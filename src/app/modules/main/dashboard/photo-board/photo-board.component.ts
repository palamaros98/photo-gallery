...
const PHOTOS_DATA: BoardPhoto[] = [
  ...
  {name: 'slide3.jpg', path: '/assets/gallery/slide3.jpg', position: {x: -100, y: 100}, transform: -2},
  {name: 'slide2.jpg', path: '/assets/gallery/slide.jpg', position: {x: 580, y: 200}, transform: 10},
];
